...
public class UsuarioServiceImpl implements UsuarioService {
  ...
  public UsuarioDTO atualizarUsuario(
      AtualizarUsuarioForms usuarioAtualizado, String codigoRegistro) {
    this.sharedUsuarioImpl.validarEmail(usuarioAtualizado);
    Usuario usuarioEncontrado = this.sharedUsuarioImpl.encontrarUsuarioPeloRegistro(codigoRegistro);
